; User defines
!define PRODUCT_EXE "GComSerial"          ;${PRODUCT_EXE}
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\${PRODUCT_EXE}.lnk" "$INSTDIR\${PRODUCT_EXE}.exe"
  CreateShortCut "$DESKTOP\${PRODUCT_EXE}.lnk" "$INSTDIR\${PRODUCT_EXE}.exe"
  !insertmacro MUI_STARTMENU_WRITE_END
SectionEnd

Section -AdditionalIcons
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
  WriteIniStr "$INSTDIR\${PRODUCT_EXE} Website.url" "InternetShortcut" "URL" "${PRODUCT_WEB_SITE}"
  WriteIniStr "$SMPROGRAMS\$ICONS_GROUP\${PRODUCT_EXE} Website.url" "InternetShortcut" "URL" "${PRODUCT_WEB_SITE}"
...
Section Uninstall
  ...
  Delete "$INSTDIR\${PRODUCT_EXE} Website.url"
  ...
  Delete "$SMPROGRAMS\$ICONS_GROUP\${PRODUCT_EXE} Website.url"
  Delete "$DESKTOP\${PRODUCT_EXE}.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\${PRODUCT_EXE}.lnk"
